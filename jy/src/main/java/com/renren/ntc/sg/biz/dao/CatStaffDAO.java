...
public interface CatStaffDAO {
    ...
    static final String FIELDS = "id,name ,phone,pwd ,type,create_time,update_time,email";
    static final String INSERT_FIELDS = "name ,phone,pwd,type,email";

    @ReturnGeneratedKeys
    @SQL("insert into " + TABLE_NAME + " (" + INSERT_FIELDS + " ) values (:1.name ,:1.phone,:1.pwd,:1.type,:1.email) ")
