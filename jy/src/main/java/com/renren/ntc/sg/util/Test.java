...
public class Test {
    ...
    public static void main (String [] args ) throws Exception{
        ...
        //
       // mysql sg -e "select phone from address where id in (select address_id from process_order  where  shop_id in (select shop_id  from catstaff_commit  where  shop_area='北苑地区') and create_time >'2015-05-25 00:00:00' and create_time <'2015-05-26 00:00:00')"
//
//
// mysql sg -e "select count( distinct user_id) from process_order  where  shop_id in (select shop_id  from catstaff_commit  where  shop_area='北苑地区') and create_time >'2015-05-25 00:00:00' and create_time <'2015-05-26 00:00:00')"
//
// try {
//
...
//				e.printStackTrace();
//			}
    	String beginDate = Dateutils.tranferDate2Str(Dateutils.getDateByCondition(-40));
		String endDate = Dateutils.tranferDate2Str(Dateutils.getDateByCondition(-12));
		System.out.println(beginDate+"|"+endDate);
		System.out.println(Dateutils.parseDate("2014-10-01 00:00:00").getTime());
		String beginTime = Dateutils.tranferDate2Str(Dateutils.getDateByCondition(-7, 0, 0, 0, 0));
        String endTime = Dateutils.tranferDate2Str(new Date());
        System.out.println(beginTime+"___"+endTime);
    	
    }
    public static int getTotalPrice(int couPonPrice){
    	int finalCouponPrice = couPonPrice % 5 ==0 ? couPonPrice/5 : (couPonPrice + 100)/5;
    	System.out.println("f"+finalCouponPrice);
    	finalCouponPrice = finalCouponPrice % 100 == 0 ? finalCouponPrice: (finalCouponPrice+100)/100;
    	return finalCouponPrice;
    }
