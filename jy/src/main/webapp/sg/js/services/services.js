...
angular.module('miaomiao.shop').factory('httpClient', ['$http', function ($http) {
        ...
        return {
            ...
            getAllCouponForUser:function(shop_id,from,offset, success, fail){

                doGet('coupon/allCoupons', 'shop_id=' + shop_id+ '&type=all&from=' + from + '&offset=' + offset , success, fail);
            },
    ...
    .factory('ShopService', ['$http', '$rootScope', '$timeout','httpClient','localStorageService',
        ...
        return {
            ...
            isWeixinEnabledShop:function(shop){
                return  (shop.id != '10026') && (shop.id != '1'); // true
            },

            isCouponEnabledShop:function(shop){
               return (shop.id !=1) ||(shop.id != 10026) ;   // shop.id == '10033';
            }
        }
