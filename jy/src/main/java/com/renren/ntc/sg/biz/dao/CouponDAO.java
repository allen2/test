...
public interface CouponDAO {
    ...
    static final String  FIELDS = "id,createer,price,shop_id,name,pic_url,ext,start_time,end_time,create_time,update_time,rule"  ;
    static final String  INSERT_FIELDS = "createer,price,shop_id,name,pic_url,ext,start_time,end_time,rule"  ;
	...
	@SQL("insert into " + TABLE_NAME + "(" + INSERT_FIELDS +" ) values"  + 
            ...
            ":1.startTimeStr,:1.endTimeStr,:1.rule)")
    ...
    @SQL("select " + FIELDS + " from " + TABLE_NAME +  " order by create_time desc")
